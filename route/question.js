...
questionRouter.get("/question/:id", validate.blogIdValidate(), validate.validate, questionController.readByIdQuestion);
...
questionRouter.delete("/question/:id", validate.blogIdValidate(), validate.validate, auth.auth, questionController.deleteQuestion);
